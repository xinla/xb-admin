...
<div>
  ...
  <Form ref="form" :model="form" :rules="rules" :label-width="120">
    ...
    <Row>
        <Col span="10">
          <FormItem label="品牌名称" prop="name">
            <selectSupplier :disabled='disabled' :val="form.name" type="insurance" @change="change" :key="form.name" />
          </FormItem>
          ...
          <FormItem label="品牌成立日期" prop="foundingTime">
            <DatePicker :disabled='disabled' type="date" format="yyyy-MM-dd HH:mm:ss" placeholder="选择时间" style="width: 100%;" :value="form.foundingTime" @on-change="changeTime"></DatePicker>
          </FormItem>
    ...
    <FormItem label="可投保地区" prop="vitDictProvinceId">
      <Select :disabled='disabled' v-model="form.vitDictProvinceId" multiple :max-tag-count="3">
    ...
    <Row>
        <Col span="10">
          <FormItem label="公司地址" prop="companyAddress">
              <Input type="text" :disabled='disabled' v-model="form.companyAddress" placeholder="公司地址"/>
          </FormItem>
      ...
      <Col span="10">
          ...
          <FormItem label="公司网址" prop="companyWebsite">
              <Input type="text" :disabled='disabled' v-model="form.companyWebsite" placeholder="公司网址"/>
          </FormItem>

          <FormItem label="全国统一服务电话" prop="nationalServicePhone">
              <Input type="text" :disabled='disabled' v-model="form.nationalServicePhone" placeholder="全国统一服务电话"/>
          </FormItem>
      </Col>
    </Row>
    ...
    border
    :columns="columns"
    :data="form.xbSupplierOrganization">
    ...
    <Row style="margin-top: 20px;" v-if="!disabled">
        <Col span="6">
          <Input :disabled='disabled' v-model="formChild.organizationDesc" placeholder="请输入名称" style="width:73%; margin-right: 10px;" />
        </Col>
        <Col span="6">
          <Input :disabled='disabled' v-model="formChild.organizationAddress" placeholder="请输入地址" style="width:73%; margin-right: 10px;" />
        </Col>
        <Col span="6">
          <Input :disabled='disabled' v-model="formChild.organizationPhone" placeholder="请输入电话" style="width:73%; margin-right: 10px;" />
        </Col>
        <Col span="6">
...
<script>
import { saveSupplier, getSupplierDetail, getSupplierBrandInformation, getInsureAllProvice } from '@/api/supplier'
